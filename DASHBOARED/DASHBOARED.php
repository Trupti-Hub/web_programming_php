  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <nav id="sidebar" class="col-md-3">
        ...
        <ul class="list-group">
          <li class="list-group-item"><a href="https://sites.google.com/view/truptipadia/" target="_blank">Google Site</a></li>
          <li class="list-group-item"><a href="https://www.linkedin.com/in/trupti-padia/" target="_blank">LinkedIn</a></li>
          <li class="list-group-item"><a href="https://employdigital.com/blog/how-to-create-a-paypal-account-as-a-freelancer/" target="_blank">Blog</a></li>
          <li class="list-group-item"><a href="https://github.com/Trupti-Hub" target="_blank">GitHub</a></li>
        </ul>
      </nav>
      <!-- Main content -->
      <main class="col-md-9">
        ...
        <div class="container">
          ...
          <div class="dashboard-item">
            ...
            <div class="btn-group">
              <a href="https://github.com/Trupti-Hub/web_programming_php/tree/main/TASK_1">
